...
void
insert_node_into_singly_linked_list (SinglyLinkedList ** singly_linked_list,
				     int node_data)
{
 ...
 *
 */
//Funcion para encontrar ciclos en una lista
...
has_cycle (SinglyLinkedListNode * head)
{
  ...
  SinglyLinkedListNode *tmp[1000];
  SinglyLinkedListNode *tmp2[1000];
  int i = 1;
  int a = 1;
  if (aux1 == NULL)
    {
