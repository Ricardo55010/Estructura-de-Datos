...
void
print_singly_linked_list (SinglyLinkedListNode * node, char *sep, FILE * fptr)
{
  while (node)
    {
 ...
 *
 */
//Funcion para agregar un dato al final de una lista ligada
//Rivera Pérez Ricardo 1CV10 Estructura de datos
SinglyLinkedListNode *
insertNodeAtTail (SinglyLinkedListNode * lista, int dato)
{
  SinglyLinkedListNode *ultNodo = malloc (sizeof (SinglyLinkedListNode));

  SinglyLinkedListNode *varTemp;
  varTemp = lista;
  if (varTemp == NULL)
    {
      ultNodo->next = NULL;
